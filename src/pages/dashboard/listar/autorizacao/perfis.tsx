...
export default function AuthorizationRoles({
  ...
  return (
    <>
      <Head>
        <title>Listagem de perfis | Studio Jul.IA</title>
      ...
      <LayoutDefault>
        <div className="flex items-center justify-between">
          <Title
            ...
            description="Aqui é possível visualizar a listagem de todas os Perfis cadastradas."
          />
        ...
        <Filter>
          <div className="mt-3 grid grid-cols-3 gap-3">
            <div>
              <label className="text-zinc-400 text-sm">Nome do perfil</label>
              <input
                type="text"
                value={filterName}
            ...
            <div>
              <label className="text-zinc-400 text-sm">Título do perfil</label>
              <input
                type="text"
                value={filterTitle}
        ...
        <Table
          ...
          tHeadOptions={['Nome', 'Título', 'Descrição']}
